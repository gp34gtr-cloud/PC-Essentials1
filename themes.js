...
const PAGE_THEMES = {
    ...
    // Peripherals - Tech Lab (grid-heavy, high-contrast, cyan accent)
    peripherals: {
        name: 'Tech Lab',
        page: 'peripherals',
        colors: {
        ...
        cardStyle: {
            borderRadius: '8px',
            padding: '24px',
            shadow: '0 0 30px rgba(0, 200, 255, 0.05)',
    ...
    // Setup Checklist - Fresh green, progress-oriented
    setup: {
        name: 'Setup Guide',
        page: 'setup',
        colors: {
        ...
        cardStyle: {
            ...
            shadow: 'none',
            hoverTransform: 'translateY(-2px)',
            hoverBorder: 'rgba(48, 209, 88, 0.3)'
        },
        animation: {
            speed: '0.25s',
            easing: 'cubic-bezier(0.25, 0.1, 0.25, 1)',
    ...
    // Shortcuts - Clean blue, reference-oriented
    shortcuts: {
        name: 'Shortcuts',
        page: 'shortcuts',
        colors: {
        ...
        cardStyle: {
            ...
            shadow: 'none',
            hoverTransform: 'translateY(-2px)',
            hoverBorder: 'rgba(0, 113, 227, 0.35)'
        },
        animation: {
            speed: '0.2s',
            easing: 'ease-out',
...
function addToCart(itemName, price) {
    ...
    if (existing) {
        ...
        cart.push({ name: itemName, price: price || null, qty: 1 });
    }
    saveCart(cart);
...
function removeFromCart(itemName) {
    const cart = getCart().filter(i => i.name !== itemName);
    saveCart(cart);
}
